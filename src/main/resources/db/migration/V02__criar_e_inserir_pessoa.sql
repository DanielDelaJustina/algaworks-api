...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Daniel Dela Justina', 'Rua neuci de carli', '198', 'loteamento passanante', 'Jardim da Colina', '85.660-000', 'Dois Vizinhos', 'PR', true);